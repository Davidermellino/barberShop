      ...
      <div className="container p-5 bg-white">
        <div className="row">
          <div className="col-12 col-md-6">
            <div className="row my-5">
              <div className="col-4 d-flex justify-content-end p-4 align-items-start">
                <img src="src/assets/Adulthaircutimg.png" alt="" />
              </div>
              <div className="col-8">
                <div className="row">
          ...
          <div className="col-12 col-md-6">
            <div className="row my-5">
              <div className="col-4 d-flex justify-content-end p-4 align-items-start">
                <img src="src/assets/Kidshaircutimg.png" alt="" />
              </div>
              <div className="col-8">
                <div className="row">
        ...
        <div className="row">
          <div className="col-12 col-md-6">
            <div className="row my-5">
              <div className="col-4 d-flex justify-content-end p-4 align-items-start">
                <img src="src/assets/Beardtrimimg.png" alt="" />
              </div>
              <div className="col-8">
                <div className="row">
          ...
          <div className="col-12 col-md-6">
            <div className="row my-5 ">
              <div className="col-4 d-flex justify-content-end p-4 align-items-start">
                <img src="src/assets/Barbershop.png" alt="" />
              </div>
              <div className="col-8">
                <div className="row">
        ...
        <div className="row">
          <div className="col-12 col-md-6">
            <div className="row my-5">
              <div className="col-4 d-flex justify-content-end p-4 align-items-start">
                <img src="src/assets/Scalpmoisturizingimg.png" alt="" />
              </div>
              <div className="col-8">
                <div className="row">
          ...
          <div className="col-12 col-md-6">
            <div className="row my-5">
              <div className="col-4 d-flex justify-content-end p-4 align-items-start">
                <img src="src/assets/Barbershop-1.png" alt="" />
              </div>
              <div className="col-8">
                <div className="row">
